...
public class Booster : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    void Start()
    {
        //TODO remove to show again all booster buttons.
        //Need to re-enable BoosterButtons Images on Unity UI too
        //to get the circles around actions back
        //HideAllBoosters(); 
        EnableBooster(false);
    }
